...
import { MILLET_QUALITY_STANDARDS } from '@/lib/site';
...
export function QualityStandardsSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-navy py-24" aria-label="Our quality promise">
      <div
      ...
      <div className="container relative">
        <SectionHeader
          ...
          title="Our Quality"
          highlight="Promise"
          subtitle="Every grain we supply meets strict international standards"
          theme="light"
        />
        ...
        >
          {MILLET_QUALITY_STANDARDS.map((item) => {
